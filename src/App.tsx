...
import logo from 'figma:asset/4962dca7ae643092f74041e10092229a63e05af2.png';
import paoFrances from 'figma:asset/7454c0427e12338cf6525cee63da02621f287633.png';
      ...
      <div className="bg-gradient-to-r from-green-800 to-green-700 text-white py-8 px-4 shadow-lg">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-center gap-3 mb-2">
            <img src={logo} alt="Empório Trimar" className="h-16" />
          </div>
